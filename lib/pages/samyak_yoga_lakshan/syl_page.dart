                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  children: [
                                    ...
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Yathakrama kapha Pitta-anila agaman \n(sequential elminaion of Kapha, pitta and anila)"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Swayama cha avasthanam (emesis Stops \non its own after elimination of all toxins)"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Kantha-shudhi(No irritation in throat)"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Srotovishudhi (clarity of channels/Bahya srotas -External \nOrifices- to be considered for immediate effects )"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Hridaya-parshva-shudhi(No \ndiscomfort in chest region and flanks)"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Indriya-shudhi(sense organs \nappearing to be more active)"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Murdha-shudhi (lightness of head \nwithout any discomfort)"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Laghuta(lightness)"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Daurbalya(fatigue)"),
                                    emptySpace(context, null, 0.005),
                                    mid_obs(context, "Swasthtaa(Decreased intensity \nof disease) - After effect"),
                                    emptySpace(context, null, 0.005),
                                    end_obs(context, "Manah-prasada(Feeling more \nhappy and contended)-After effect"),
                                    emptySpace(context, null, 0.005),
                                  ],
                                ),
                              ),
